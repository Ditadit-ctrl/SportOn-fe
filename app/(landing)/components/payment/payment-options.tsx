...
const PaymentOptions = () => {
    return (
        <CardWithHeader title="Payment Options" className="h-fit">
            {
                paymentList.map((payment, index) => (
                    <div key={index} className="flex gap-5 p-5 border border-gray-100">
                        ...
                        <div className="ml-auto bg-blue-50 text-gray-800 text-xs h-fit self-center px-2 py-1">Bank Tranfer</div>
                    </div>
