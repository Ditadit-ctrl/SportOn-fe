...
const HeroSection = () => {
    return (
        <section id="hero-section" className="mx-auto flex lg:h-screen overflow-hidden py-10">
            <div className="relative self-center mx-auto">
                <Image src="/img/hero/home/img-basketball.png" alt="hero image" width={532} height={532} className="absolute -top-20 -z-100 -left-65 grayscale" />
                <div className="px-[10px] relative w-full flex items-center flex-col lg:ml-10 lg:block">
                    ...
                    <Image src="/img/hero/home/img-hero.png" alt="hero image" width={723} height={787} className="lg:absolute lg:-right-5 lg:top-1/2 lg:-translate-y-1/2 -z-10 w-[323] h-[387] sm:w-[523] sm:h-[587] md:w-[723] md:h-[787]" />
                    ...
                    <div className="flex gap-5 mt-10">
                        ...
                        <Button variant="ghost" className="">Watch Video <Image src="/img/hero/home/Play.svg" alt="icon play video" width={16} height={16} /></Button>
                    </div>
                    <Image src="/img/hero/home/Hero-Ornament.svg" alt="hero decor" width={513} height={513} className="absolute -right-2/5 top-2/5 -translate-y-1/2 -z-100" />
                </div>
            </div>
        </section>
    )
