...
const ProductSection = () => {
    ...
    return (
        <section id="product-section" className="mx-auto mt-20 pb-10 px-4 md:container overflow-x-hidden mb-20">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-x-3 gap-y-10">
                {
                    productList.map((product, index) => (
                        <Link href={`/product/${product.name}`} className="p-2 overflow-y-clip hover:shadow-lg duration-200" key={index}>
                            ...
                            <div className="bg-white flex flex-col gap-2 mt-4 pb-8">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between">
                                    ...
                                    <span className="text-[13px] sm:text-lg text-primary">{priceFormatter(product.price)}</span>
                                </div>
                            </div>
                        </Link>
                    ))
